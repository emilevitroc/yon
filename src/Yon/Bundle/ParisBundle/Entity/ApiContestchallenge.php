...
class ApiContestchallenge
{
     ...
     * @var \ApiChallenge
     *
     * @ORM\ManyToOne(targetEntity="\Yon\Bundle\ParisBundle\Entity\ApiChallenge", inversedBy="contestChallenge")
     * @ORM\JoinColumns({
     ...
     * Set contest
     *
     * @param \Yon\Bundle\ParisBundle\Entity\ApiContest $contest
     * @return ApiContestchallenge
     */
